  ...
  return (
    <div class={Style.footer}>
      <div class={Style.footer_box}>
        <div class={Style.footer_box_social}>
          <a href="/">
            <Logo className={Style.footer_box_social_logo} />
          </a>
          <p class={Style.footer_box_social_info}>
        ...
        <div class={Style.footer_box_help}>
          <h3>Help Center</h3>
        ...
        <div class={Style.subscribe}>
          <h3>Subscribe</h3>
          <div class={Style.subscribe_box}>
            <input type="email" placeholder="Enter your email *" />
            <RiSendPlaneFill className={Style.subscribe_box_send} />
          </div>
          <div class={Style.subscribe_box_info}>
            <p>
